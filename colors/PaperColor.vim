...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
  ...
  call <SID>X("scalaDefSpecializer", s:aqua, "", "")
  call <SID>X("scalaClassSpecializer", s:aqua, "", "")
  call <SID>X("scalaBackTick", s:olive, "", "")
  call <SID>X("scalaRoot", s:foreground, "", "")
  call <SID>X("scalaMethodCall", s:blue, "", "")
  call <SID>X("scalaCaseType", s:aqua, "", "")
  ...
  call <SID>X("scalaConstructorSpecializer", s:aqua, "", "")
